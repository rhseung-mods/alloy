...
abstract class AlloyFluid(
    val alloyMixingRatioComponent: AlloyMixingRatioComponent,
) : SmartFluid(Utils.alloyName(alloyMixingRatioComponent.mixingRatio)) {

    override fun getStill(): Fluid {
        if (alloyMixingRatioComponent !in AlloyInstance.INSTANCES)
            AlloyInstance.INSTANCES[alloyMixingRatioComponent] = AlloyInstance.Instance(
                Still(alloyMixingRatioComponent),
                Flowing(alloyMixingRatioComponent),
                SmartFluidBlock(name, this),
                SmartBucketItem(name, this)
            );

        return AlloyInstance.INSTANCES[alloyMixingRatioComponent]!!.stillFluid;
    }
    ...
    override fun getFlowing(): Fluid {
        ...
        return AlloyInstance.INSTANCES[alloyMixingRatioComponent]!!.flowingFluid;
    }
    ...
    override fun getBucketItem(): Item {
        ...
        return AlloyInstance.INSTANCES[alloyMixingRatioComponent]!!.bucket;
    }
    ...
    override fun toBlockState(state: FluidState): BlockState {
        ...
        return AlloyInstance.INSTANCES[alloyMixingRatioComponent]!!.fluidBlock
            .defaultState.with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    class Still(alloyMixingRatioComponent: AlloyMixingRatioComponent) : AlloyFluid(alloyMixingRatioComponent) {
        init {
            assert(alloyMixingRatioComponent !in AlloyInstance.INSTANCES);
        }
    ...
    class Flowing(alloyMixingRatioComponent: AlloyMixingRatioComponent) : AlloyFluid(alloyMixingRatioComponent) {
        init {
            assert(alloyMixingRatioComponent !in AlloyInstance.INSTANCES);
        }
